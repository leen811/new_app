...
class MyMeetingsSummary extends StatelessWidget {
  final MeetingsKpis kpis;
  final int todayCount;
  const MyMeetingsSummary({super.key, required this.kpis, this.todayCount = 0});

  @override
  Widget build(BuildContext context) {
    final items = [
      _Item('اليوم', todayCount, const Color(0xFFE7F0FF), Icons.today_rounded),
      _Item('القادمة', kpis.scheduled, const Color(0xFFE7F0FF), Icons.schedule_rounded),
      _Item('المكتملة', kpis.completed, const Color(0xFFE8F5E9), Icons.verified_rounded),
      _Item('الدقائق', kpis.totalMinutes, const Color(0xFFFFF3CD), Icons.timelapse_rounded),
    ];
    return Padding(
