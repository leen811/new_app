...
class EmployeePresenceTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final statusBg = item.isCheckedIn
        ? const Color(0xFFE8F5E9)
        : const Color(0xFFF3F4F6);
    final statusFg = item.isCheckedIn
        ? const Color(0xFF16A34A)
        : const Color(0xFF9AA3B2);
    final statusIcon = item.isCheckedIn
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  // الحالة أسفل الاسم مباشرة (دائمًا)
                  Container(
                  ...
                  if (item.isCheckedIn) ...[
                    ...
                    // الموقع الحالي يظهر فقط إذا كان حاضرًا
                    Text(
                      'الموقع الحالي: ${item.lastLocationName ?? '-'}',
                      style: const TextStyle(color: Color(0xFF6B7280)),
                    ),
                  ],
                ],
